          ...
          <table class="table table-hover">
            <thead>
              <tr>
                  ...
                  <th scope="col"><?= $this->Paginator->sort('prefix_code') ?></th>
              ...
              <?php foreach ($countries as $country): ?>
                <tr>
                  ...
                  <td class="actions text-right">
                      ...
                      <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $country->id], ['confirm' => __('Are you sure you want to delete # {0}?', $country->id), 'class'=>'btn btn-danger btn-xs']) ?>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
