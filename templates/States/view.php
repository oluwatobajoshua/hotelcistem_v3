      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          ...
          <table class="table table-hover">
              ...
              <?php foreach ($state->guests as $guests): ?>
              <tr>
                    <td><?= h($guests->id) ?></td>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          <i class="fa fa-share-alt"></i>
          <h3 class="box-title"><?= __('Locals') ?></h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          ...
          <table class="table table-hover">
              ...
              <tr>
                    ...
                    <td><?= h($locals->name) ?></td>
                      <td class="actions text-right">
                      <?= $this->Html->link(__('View'), ['controller' => 'Locals', 'action' => 'view', $locals->id], ['class'=>'btn btn-info btn-xs']) ?>
                      <?= $this->Html->link(__('Edit'), ['controller' => 'Locals', 'action' => 'edit', $locals->id], ['class'=>'btn btn-warning btn-xs']) ?>
                      <?= $this->Form->postLink(__('Delete'), ['controller' => 'Locals', 'action' => 'delete', $locals->id], ['confirm' => __('Are you sure you want to delete # {0}?', $locals->id), 'class'=>'btn btn-danger btn-xs']) ?>
                  </td>
              </tr>
              <?php endforeach; ?>
          </table>
